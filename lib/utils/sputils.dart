...
class SPUtils {
  ...
  static Future<bool> saveUserId(String userId) {
    return _spf.setString('key_userid', userId);
  }

  ///昵称
  static Future<bool> saveName(String name) {
    return _spf.setString('key_name', name);
  }

  static Future<bool> saveTypeId(String typeId) {
    return _spf.setString('key_typeid', typeId);
  }

  static String getTypeId() {
    return _spf.getString('key_typeid');
  }

  static String getName() {
    return _spf.getString('key_name');
  }

  static Future<bool> saveWebUserId(String webUserId) {
    return _spf.setString('key_webuserid', webUserId);
  }

  static String getWebUserId() {
    return _spf.getString('key_webuserid');
  }

  static Future<bool> saveNotice(String notice) {
    return _spf.setString('key_notice', notice);
  }

  static String getNotice() {
    return _spf.getString('key_notice');
  }

  static String getUserId() {
    return _spf.getString('key_userid');
  }
